...
public class ZZScorpioAdmin extends JFrame {

	private JPanel contentPane;
	public static JTextArea taScorpioAdmin;

	public ZZScorpioAdmin() {
		setTitle("EDIT SCORPIO");
		...
		JLabel lbl2 = new JLabel("SCORPIO :");
		...
		taScorpioAdmin = new JTextArea();
		taScorpioAdmin.setBounds(95, 270, 740, 190);
		taScorpioAdmin.setText("\n You have a lot of thinking to do about your professional goals, Scorpio. \n You'll go over the elements to see if there isn't some way to approach things differently. \n Are there new paths you could try or ways to improve things? \n Your mind will go a thousand miles a minute today.\n Those who interact with you may be totally exhausted by the end of the day because of all the\n questions you ask!");
		taScorpioAdmin.setFont(new Font("Lucida Grande", Font.PLAIN, 15));
		contentPane.add(taScorpioAdmin);
		
		JButton btnView = new JButton("VIEW");
		btnView.setBounds(690, 500, 140, 50);
		btnView.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String srScorpio = taScorpioAdmin.getText();
				ZZScorpio z8 = new ZZScorpio();
				z8.taScorpio.setText(srScorpio);
				z8.setVisible(true);
			}
		});
	...
	public static void main(String[] args) {
		ZZScorpioAdmin frame = new ZZScorpioAdmin();

...
public class ZZCapricorn extends JFrame {

	private JPanel contentPane;
	public static JTextArea taCapricorn;
	...
	public ZZCapricorn() {
		...
		JLabel lbl1 = new JLabel("CAPRICORN :");
		lbl1.setBounds(37, 17, 367, 50);
		lbl1.setFont(new Font("Lucida Grande", Font.BOLD, 50));
		contentPane.add(lbl1);
		
		JLabel lbl2 = new JLabel("");
		lbl2.setBounds(122, 90, 266, 200);
		lbl2.setIcon(new ImageIcon("/Users/siddharth_agarwal/Desktop/java_eclipse/Horoscope_GUI/src/capricorn_goat.png"));
		contentPane.add(lbl2);
		
		JLabel lbl3 = new JLabel("The GOAT");
		lbl3.setBounds(172, 300, 159, 30);
		...
		JLabel lbl12 = new JLabel("DATES :  DEC 22 - JAN 19");
		...
		taCapricorn = new JTextArea();
		taCapricorn.setBounds(80, 400, 740, 190);
		taCapricorn.setFont(new Font("Lucida Grande", Font.PLAIN, 15));
		contentPane.add(taCapricorn);
		taCapricorn.setEditable(false);
		String srCapricorn = zzz10.taCapricornAdmin.getText();
		taCapricorn.setText(srCapricorn);
	...
	public static void main(String[] args) {
		ZZCapricorn frame = new ZZCapricorn();

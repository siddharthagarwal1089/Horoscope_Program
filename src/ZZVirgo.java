...
public class ZZVirgo extends JFrame {

	private JPanel contentPane;
	public static JTextArea taVirgo;
	...
	public ZZVirgo() {
		...
		JLabel lbl1 = new JLabel("VIRGO :");
		lbl1.setBounds(37, 17, 367, 50);
		lbl1.setFont(new Font("Lucida Grande", Font.BOLD, 50));
		contentPane.add(lbl1);
		
		JLabel lbl2 = new JLabel("");
		lbl2.setBounds(180, 90, 159, 200);
		lbl2.setIcon(new ImageIcon("/Users/siddharth_agarwal/Desktop/java_eclipse/Horoscope_GUI/src/virgo_maiden.png"));
		contentPane.add(lbl2);
		
		JLabel lbl3 = new JLabel("The MAIDEN");
		lbl3.setBounds(150, 296, 199, 30);
		...
		JLabel lbl6 = new JLabel("Color :  GREY");
		...
		JLabel lbl12 = new JLabel("DATES :  AUG 23 - SEP 22");
		...
		taVirgo = new JTextArea();
		taVirgo.setBounds(80, 400, 740, 190);
		taVirgo.setFont(new Font("Lucida Grande", Font.PLAIN, 15));
		contentPane.add(taVirgo);
		taVirgo.setEditable(false);
		String srVirgo = zzz6.taVirgoAdmin.getText();
		taVirgo.setText(srVirgo);

...
public class ZZSagittariusAdmin extends JFrame {

	private JPanel contentPane;
	public static JTextArea taSagittariusAdmin;

	public ZZSagittariusAdmin() {
		setTitle("EDIT SAGITTARIUS");
		...
		JLabel lbl2 = new JLabel("SAGITTARIUS :");
		lbl2.setBounds(34, 130, 400, 50);
		...
		taSagittariusAdmin = new JTextArea();
		taSagittariusAdmin.setBounds(95, 270, 740, 190);
		taSagittariusAdmin.setText("\n You just can't do everything at once, Sagittarius. \n How do you expect to reduce your stress and recuperate while you keep pushing yourself to be a\n superstar performer in every area of your life? \n Don't pressure yourself to perform today. \n If you do, you're likely to deplete your reserves even further. \n Take it easy, rest, and relax! \n You've earned this little break.");
		taSagittariusAdmin.setFont(new Font("Lucida Grande", Font.PLAIN, 15));
		contentPane.add(taSagittariusAdmin);
		
		JButton btnView = new JButton("VIEW");
		btnView.setBounds(690, 500, 140, 50);
		btnView.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String srSagittarius = taSagittariusAdmin.getText();
				ZZSagittarius z9 = new ZZSagittarius();
				z9.taSagittarius.setText(srSagittarius);
				z9.setVisible(true);
			}
		});
	...
	public static void main(String[] args) {
		ZZSagittariusAdmin frame = new ZZSagittariusAdmin();

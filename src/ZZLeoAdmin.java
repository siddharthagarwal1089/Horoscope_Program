...
public class ZZLeoAdmin extends JFrame {

	private JPanel contentPane;
	public static JTextArea taLeoAdmin;
	...
	public ZZLeoAdmin() {
		...
		taLeoAdmin = new JTextArea();
		taLeoAdmin.setBounds(95, 270, 740, 190);
		taLeoAdmin.setText("\n You may have been feeling somewhat disillusioned. \n Perhaps you lost sight of your goals or misplaced your faith in yourself. \n You'll feel some relief beginning today. \n This is an opportunity to end what has been a somewhat apathetic and moody phase and begin a\n new one that's based on work and meditation. \n As you can imagine, this new phase will be much more fulfilling!");
		taLeoAdmin.setFont(new Font("Lucida Grande", Font.PLAIN, 15));
		contentPane.add(taLeoAdmin);
		
		JButton btnView = new JButton("VIEW");
		btnView.setBounds(690, 500, 140, 50);
		btnView.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String srLeo = taLeoAdmin.getText();
				ZZLeo z5 = new ZZLeo();
				z5.taLeo.setText(srLeo);
				z5.setVisible(true);
			}
		});
	...
	public static void main(String[] args) {
		ZZLeoAdmin frame = new ZZLeoAdmin();

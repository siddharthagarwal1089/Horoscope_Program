...
public class ZZCapricornAdmin extends JFrame {

	private JPanel contentPane;
	public static JTextArea taCapricornAdmin;

	public ZZCapricornAdmin() {
		setTitle("EDIT CAPRICORN");
		...
		JLabel lbl2 = new JLabel("CAPRICORN :");
		...
		taCapricornAdmin = new JTextArea();
		taCapricornAdmin.setBounds(95, 270, 740, 190);
		taCapricornAdmin.setText("\n This is a good moment to adapt your logic and reason to reality, Capricorn. \n If you don't, you're going to run into some intellectual problems. \n Everyone knows that you are a wealth of new ideas, but unless you have plans to be a novelist, link\n these ideas to practical matters. \n The \"pie in the sky\" thinking that you engage in isn't particularly useful to the issues at hand that\n need your immediate attention.");
		taCapricornAdmin.setFont(new Font("Lucida Grande", Font.PLAIN, 15));
		contentPane.add(taCapricornAdmin);
		
		JButton btnView = new JButton("VIEW");
		btnView.setBounds(690, 500, 140, 50);
		btnView.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String srCapricorn = taCapricornAdmin.getText();
				ZZCapricorn z10 = new ZZCapricorn();
				z10.taCapricorn.setText(srCapricorn);
				z10.setVisible(true);
			}
		});
	...
	public static void main(String[] args) {
		ZZCapricornAdmin frame = new ZZCapricornAdmin();

...
public class ZZTaurus extends JFrame {

	private JPanel contentPane;
	public static JTextArea taTaurus;
	...
	public ZZTaurus() {
		...
		JLabel lbl1 = new JLabel("TAURUS :");
		lbl1.setBounds(37, 17, 367, 50);
		lbl1.setFont(new Font("Lucida Grande", Font.BOLD, 50));
		contentPane.add(lbl1);
		
		JLabel lbl2 = new JLabel("");
		lbl2.setBounds(170, 90, 160, 200);
		lbl2.setIcon(new ImageIcon("/Users/siddharth_agarwal/Desktop/java_eclipse/Horoscope_GUI/src/taurus_bull.png"));
		contentPane.add(lbl2);
		
		JLabel lbl3 = new JLabel("The BULL");
		lbl3.setBounds(180, 293, 150, 30);
		...
		JLabel lbl9 = new JLabel("Lucky Numbers :  2, 6, 9, 12, 24");
		lbl9.setBounds(483, 214, 385, 30);
		lbl9.setForeground(Color.DARK_GRAY);
		lbl9.setFont(new Font("Lucida Grande", Font.BOLD, 23));
		contentPane.add(lbl9);
		
		JLabel lbl10 = new JLabel("Compatibility :  SCORPIO");
		...
		JLabel lbl12 = new JLabel("DATES :  APR 20 - MAY 20");
		...
		taTaurus = new JTextArea();
		taTaurus.setBounds(80, 400, 740, 190);
		taTaurus.setFont(new Font("Lucida Grande", Font.PLAIN, 15));
		contentPane.add(taTaurus);
		taTaurus.setEditable(false);
		String srTaurus = zzz2.taTaurusAdmin.getText();
		taTaurus.setText(srTaurus);

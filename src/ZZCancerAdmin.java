...
public class ZZCancerAdmin extends JFrame {

	private JPanel contentPane;
	public static JTextArea taCancerAdmin;

	public ZZCancerAdmin() {
		setTitle("EDIT CANCER");
		...
		taCancerAdmin = new JTextArea();
		taCancerAdmin.setBounds(95, 270, 740, 190);
		taCancerAdmin.setText("\n Have you felt somewhat lost for the past few days? \n The fog may lift today and enable you to situate yourself at last. \n You're probably eager to settle a question that has nagged at you and interfered with your\n judgment. \n However, you should be patient, especially if it has to do with emotional matters. \n Try to understand, but don't take immediate action. \n You'll be more objective beginning tomorrow.");
		taCancerAdmin.setFont(new Font("Lucida Grande", Font.PLAIN, 15));
		contentPane.add(taCancerAdmin);
		
		JButton btnView = new JButton("VIEW");
		btnView.setBounds(690, 500, 140, 50);
		btnView.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String srCancer = taCancerAdmin.getText();
				ZZCancer z4 = new ZZCancer();
				z4.taCancer.setText(srCancer);
				z4.setVisible(true);
			}
		});
	...
	public static void main(String[] args) {
		ZZCancerAdmin frame = new ZZCancerAdmin();
